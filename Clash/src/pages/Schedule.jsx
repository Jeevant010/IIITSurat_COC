  ...
  return (
    <div>
      <div className="page-head">
        <h1>War Schedule</h1>
        <div className="sub">Times shown in your local timezone</div>
      </div>
            ...
            <div key={m._id} className={`card pro ${m.status}`}>
              <div className="card-head">
                <div className="badges">
                  <span className="badge">{(m.stage || 'group').toUpperCase()}</span>
              ...
              <div className="card-body">
                ...
                <ProgressBar value={hd} max={100} />
                <div className="row row-sides">
                  <div className="side-name">{m.awayTeam?.name}</div>
                  <div className="side-score">{as}⭐ • {ad}%</div>
                </div>
                <ProgressBar value={ad} max={100} color="linear-gradient(90deg, #55b6ff, #6fd4ff)" />
              </div>
            </div>
          );
        })}
